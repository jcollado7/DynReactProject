        ...
        async def run(self):
            ...
            if log_status_var =="on":
                ...
                if msg:
                    ...
                    print(msg_sender_jid0)
                    msg_sender_jid = msg_sender_jid0[:-31]
                    print("ESTE ES EL JID", msg_sender_jid)
                    ...
                    if x:                                     #update  coil status
                        ...
                        print("Cambiando almacenes en Log, desde Launcher")
                        ...
                        if id[3] == 'steel_grade':  #Save order
                            asf.save_order(msg.body) #Se guarda el pedido
                            logger.info(msg.body)
                            m = "Status: Order successfully saved"
                            log_msg_la = asf.msg_to_launcher(m, my_dir)
