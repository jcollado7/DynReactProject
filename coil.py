        ...
        async def run(self):
            ...
            if coil_status_var == "auction":
                ...
                if va_coil_msg:
                    ...
                    #Preguntar Browser loc
                    coil_request_type = "my location"
                    coil_msg_br_body = asf.req_active_users_loc_times(coil_df, coil_request_type)
                    print(coil_msg_br_body)  # returns a json with request info to browser
