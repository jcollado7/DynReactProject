        ...
        async def run(self):
            ...
            if br_status_var == "on":
                if br_int_fab == "yes":
                    ...
                    int_fab_msg_body = asf.br_int_fab_df(br_data_df).to_json(orient="records")
                ...
                br_inform_json = asf.log_status(my_full_name, br_status_var, ip_machine)
