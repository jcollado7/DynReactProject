    ...
    class VABehav(PeriodicBehaviour):
        async def run(self):
            ...
            if va_status_var == "pre-auction":
                ...
                print(va_msg_br_body) #returns a json with request info to browser
                va_msg_br = asf.msg_to_br(va_msg_br_body, my_dir)
            ...
            if va_status_var == "auction":
                if not coil_msgs_df.empty:
                    ...
                    print("The df of the coil bid is: \n", coil_msgs_df)
                    ...
                    print("The df of the valuation of the bid by VA is: \n", bid_coil)
                    ...
                    for i in range(len(jid_list)):
                        ...
                        if coil_msg:
                            ...
                            if msg_sender_jid == "c0":
                                ...
                                await self.send(va_msg_log)
                                print(va_msg_log_body)
                                print("Message is received from another agent (not from Coil agent).")
                        else:
                            """Inform log """
                    ...
                    if not coil_msgs_df_2.empty:
                        ...
                        print("The df of the coil counterbid is: \n", coil_msgs_df_2)
                        ...
                        print("The df of the valuation of the counterbid by VA is: \n", counterbid_coil)
                    ...
                    print("No message received from Browser")
                    va_status_var = 'pre-auction'
